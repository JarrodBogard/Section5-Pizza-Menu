  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          {" "}
          {/* React.Fragment if a key is required */}
          <p>
      ...
      <Pizza
        ...
        ingredients="Tomato, onion, mushrooms, mozarella"
      /> */}
    </main>
  );
}
...
function Footer() {
  ...
  // if (!isOpen) return ( <footer className="footer"><p>CLOSED</p></footer> );
